...
var imageArray = new Array("images/endFrame.jpg");
...
.add( function() {tl_textEnd.play()}, "<" )

.from("#endFrame", 3, { scale: 1.3, transformOrigin: "50% 80%", ease: "power3.out"}, "<")
.add( function() {triggerConfetti();}, "<" )

.from("#video1", { duration: 0.5, opacity: 0, ease: "power1.out", onComplete: function () { myVideo.play(); } }, "<+0.5")
.from("#video1", { duration: 0.65, scale: 1.1, rotation: 0.05, ease: "power1.out", onComplete: function () { myVideo.play(); } }, "<")
...
myVideo.addEventListener("timeupdate", function () {
  if (myVideo.currentTime >= 14 && !animTriggered) {
    animTriggered = true;
    playMidAnimation();
  }
});
